...
function SwitchDependency() {
    ...
    $newDependencyPath = Join-Path $extractPath 'lib/net45/Newtonsoft.Json.dll'
    $pathToOverwrite = Join-Path $projectFolder 'bin/Debug/net472/publish/Newtonsoft.Json.dll'
